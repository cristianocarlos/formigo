...
export default function ComboOrSuggestDataList<GOptionData extends TComboOrSuggestOptions[number]>(
  ...
  return (
    <div
      className={`formigo--z-input-picker combo-or-suggest-data-list absolute w-full overflow-hidden rounded-sm bg-white text-gray-600 shadow-md transition-all duration-200 ease-in-out`}
      id={ariaOwnsId}
      role="listbox"
      style={wrapperStyle}
    >
